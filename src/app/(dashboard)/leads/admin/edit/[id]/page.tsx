...
// const BASE = "https://chat.swiftandgo.in"; // base URL provided
...
//   const { data, error, isLoading, mutate } = useSWR<Lead>(`${BASE}/leads/${params.id}`, fetcher, {
...
//                         <div className="text-sm">{fmt(String(data?.mobileNumber ?? ""))}</div>
//                       </div>
