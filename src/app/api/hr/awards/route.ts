...
const API_URL = "https://6jnqmj85-8080.inc1.devtunnels.ms/employee/api/awards"
...
export async function POST(req: NextRequest) {
  try {
    ...
    const res = await fetch(`https://6jnqmj85-8080.inc1.devtunnels.ms/employee/api/awards`, {
      method: "POST",
      headers: {
